...
Copy only the text inside each block. Counts include Markdown and line breaks (LF), excluding the surrounding code fences.

## Teaser card description (89/120)
...
- Tune sensitivity, bass/detail and textures.
- Choose profiles or save your own.
