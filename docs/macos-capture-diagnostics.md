...
3. Play audible audio through that selected output. Packet/sample counters should increase, raw peak should rise above -180 dBFS, and status should become Listening. Silence should show Silent audio; disconnected/stalled capture should not remain Listening.
...
Local Windows builds/protocol tests cannot validate LaunchServices, TCC prompts, USB audio in ESXi, or actual Mac loopback. Live success remains pending.
