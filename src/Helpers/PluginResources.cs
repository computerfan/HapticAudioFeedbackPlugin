namespace Loupedeck.HapticAudioFeedback
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.TutorialPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.TutorialPlugin.Resources.Resource.txt`.
